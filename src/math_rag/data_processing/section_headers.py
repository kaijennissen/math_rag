...
class SectionHeaders:
    ...
    def _parse(self):
        for section_key, subsections in self.raw_data.items():
            ...
            for subsection in subsections:
                ...
                if not sub_match:
                    continue
                # sub_section_number = int(sub_match.group(1))
                # Not used, but could check for consistency
    ...
    def get_subsection_title(
        ...
        # Convert subsection number to float for comparison
        # (e.g., 1.2 for section 1, subsection 2)
